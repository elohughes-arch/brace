...
const STAGES = ['discover', 'triage', 'clip', 'screen', 'prelabel', 'recut', 'dataset', 'train', 'scrub', 'ingest', 'climb', 'rejudge', 'health', 'prototype'];
...
const PASSTHROUGH = ['limit', 'unreviewed', 'name', 'every', 'conf',
  'epochs', 'imgsz', 'base', 'phases', 'dry', 'url', 'rf', 'extra',
  'metrics', 'model', 'trial', 'run'];
